...
<body>
	...
	<div class="container my-5">
		...
		<a class="btn btn-primary" href="../crud/create.php" role="button">Nuevo Estudiante</a>
		<br>
			...
			<tbody>
					...
					while ($row = $result->fetch_assoc()) {
						...
						<tr>
							...
							<td>$row[correo]</td>
							<td>
								<a class='btn btn-primary btn-sm' href='../crud/editar.php?id=$row[id]'>Editar</a>
								<a class='btn btn-danger btn-sm' href='../crud/eliminar.php?id=$row[id]'>Eliminar</a>
