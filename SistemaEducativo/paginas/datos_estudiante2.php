...
<body>
	...
	<div class="container my-5">
		...
		<a class="btn btn-primary" href="../../crud/create2.php" role="button">Nuevo Estudiante</a>
		<br>
			...
			<tbody>
					...
					while ($row = $result->fetch_assoc()) {
						...
						<tr>
							...
							<td>$row[correo]</td>
							<td>
								<a class='btn btn-primary btn-sm' href='../../crud/editar2.php?id=$row[id]'>Editar</a>
								<a class='btn btn-danger btn-sm' href='../../crud/eliminar2.php?id=$row[id]'>Eliminar</a>
