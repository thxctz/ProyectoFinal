...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	...
	$sql = "SELECT * FROM estudiante_b WHERE id=$id";
	...
	do{
		...
		// ACTUALIAZAR
		$sql = "UPDATE estudiante_b " . "SET nombre = '$nombre', apellido = '$apellido', dni='$dni', fecha_nac = '$nacimiento', correo = '$correo' " . 
			   "WHERE id = $id";
		...
		<form method="post">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-3 d-grid">
					<a class="btn btn-outline-primary" href="../../../../paginas/datos_estudiante2.php" role="button">Cancel</a>
				</div>
